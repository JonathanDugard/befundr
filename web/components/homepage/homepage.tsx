...
const Homepage = (/*props: Props*/) => {
    ...
    return (
        <div className='flex flex-col items-center justify-start gap-10 '>
            ...
            <h3 className='textStyle-headline w-2/3 text-center'>With beFundr, contribute to early projects in the most secure way. Don&apos;t want to wait for the project&apos;s delivery? Buy an available reward directly.</h3>
            <KeyFigures/>   
